...
def main():
    ...
    ap.add_argument("--num-chunks", type=int, default=4, help="Number of coarse chunks (default: 8).")
    ...
    ap.add_argument("--cpus", type=int, default=16, help="CPUs per task.")
    ap.add_argument("--gpus-per-task", type=int, default=1, help="GPUs per task (Slurm level).")
    ap.add_argument("--mem", type=str, default="64G", help="Memory per task, e.g., 32G.")
    ...
    ap.add_argument("--conda-env", type=str, default='tabft', help="Conda env to activate inside the job.")
